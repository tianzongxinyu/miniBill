...
func (s *Server) Router() *gin.Engine {
	...
	protected.GET("/stats/home-rankings", s.homeRankings)
	...
	protected.GET("/stats/annual-report", s.annualReport)
	protected.GET("/stats/annual-default-year", s.annualDefaultYear)
